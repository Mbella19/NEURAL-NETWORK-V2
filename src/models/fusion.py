...
# NOTE: SimpleFusion and ConcatFusion classes have been archived to:
# archive/legacy_code/fusion_alternatives.py
# They were never used in production (AttentionFusion is the active implementation).
